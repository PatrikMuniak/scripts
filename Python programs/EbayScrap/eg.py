...
wb = openpyxl.Workbook()   #!!!CHANGE THIS WHEN IMPLEMENTING SYS.ARGV
ws = wb.active
ws.title=str('_'.join(keywords))
...
for tuple_ in data:
    ...
    r+=1
path=r'C:\Users\Patrick\Desktop\\'
wb.save(str(path)+str(' '.join(keywords)+'.xlsx'))
